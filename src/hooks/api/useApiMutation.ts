...
export interface UseApiMutationResult<TData, TVariables> extends ApiMutationState<TData> {
  mutate: (variables: TVariables) => Promise<TData>;
  mutateAsync: (variables: TVariables) => Promise<TData>;
  reset: () => void;
}

export type MutationFunction<TData, TVariables> = (variables: TVariables) => Promise<ApiResponse<TData>>;
