...
export type AttendantStatus =
  (typeof ATTENDANT_STATUS)[keyof typeof ATTENDANT_STATUS];
...
export type AnalyzeEvaluationInput = z.infer<
  typeof AnalyzeEvaluationInputSchema
>;

export const AnalyzeEvaluationOutputSchema = z.object({
  sentiment: z
    .enum(["Positivo", "Negativo", "Neutro"])
    .describe("A classificação do sentimento do comentário."),
  summary: z.string().describe("Um resumo conciso de uma frase do comentário."),
});
export type AnalyzeEvaluationOutput = z.infer<
  typeof AnalyzeEvaluationOutputSchema
>;
