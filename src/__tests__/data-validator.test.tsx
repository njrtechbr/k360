...
describe("DataValidator", () => {
  const mockChildren = jest.fn((data) => (
  ...
  describe("Loading State", () => {
    it("should render loading state when loading is true", () => {
      render(
        <DataValidator data={null} fallback={[]} loading={true}>
          {mockChildren}
        </DataValidator>,
      );
  ...
  describe("Empty State", () => {
    ...
    it("should render custom empty message", () => {
      ...
      render(
        <DataValidator data={[]} fallback={[]} emptyMessage={customMessage}>
          {mockChildren}
        </DataValidator>,
      );
    ...
    it("should render custom empty component when provided", () => {
      ...
      render(
        <DataValidator data={[]} fallback={[]} emptyComponent={customEmpty}>
          {mockChildren}
        </DataValidator>,
      );
    ...
    it("should not treat empty array as empty when treatEmptyArrayAsEmpty is false", () => {
      render(
        <DataValidator data={[]} fallback={[]} treatEmptyArrayAsEmpty={false}>
          {mockChildren}
        </DataValidator>,
      );
  ...
  describe("Valid State", () => {
    it("should render content with valid data", () => {
      ...
      render(
        <DataValidator data={testData} fallback={[]}>
          {mockChildren}
        </DataValidator>,
      );
    ...
    it("should use fallback when data is null", () => {
      ...
      render(
        <DataValidator data={null} fallback={fallback} enableWarnings={false}>
          {mockChildren}
        </DataValidator>,
      );
  ...
  describe("Custom Validation", () => {
    it("should use custom validator", () => {
      ...
      render(
        <DataValidator data={testData} fallback={[]} validator={validator}>
          {mockChildren}
        </DataValidator>,
      );
  ...
  describe("Warnings", () => {
    it("should log warning when data is null and enableWarnings is true", () => {
      ...
      render(
        <DataValidator data={null} fallback={[]} enableWarnings={true}>
          {mockChildren}
        </DataValidator>,
      );
    ...
    it("should not log warning when enableWarnings is false", () => {
      ...
      render(
        <DataValidator data={null} fallback={[]} enableWarnings={false}>
          {mockChildren}
        </DataValidator>,
      );
  ...
  describe("CSS Classes", () => {
    it("should apply custom className", () => {
      const { container } = render(
        <DataValidator data={[1, 2, 3]} fallback={[]} className="custom-class">
          {mockChildren}
        </DataValidator>,
      );
