...
export default function AttendantTableExample() {
  ...
  return (
    <div className="space-y-8 p-6">
      <h1 className="text-2xl font-bold">Exemplos do AttendantTable Refatorado</h1>
      
      {/* Exemplo 1: Dados válidos */}
      <section>
        <h2 className="text-xl font-semibold mb-4">1. Tabela com dados válidos</h2>
        <AttendantTable
      ...
      <section>
        <h2 className="text-xl font-semibold mb-4">4. Dados null (validação robusta)</h2>
        <AttendantTable
          attendants={null}
          isLoading={false}
          error={null}
      ...
      <section>
        <h2 className="text-xl font-semibold mb-4">6. Dados com propriedades undefined</h2>
        <AttendantTable
          attendants={[
            {
              ...exampleAttendants[0],
