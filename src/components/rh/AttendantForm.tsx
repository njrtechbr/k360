...
export default function AttendantForm({ 
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-6 pl-2">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FormField control={form.control} name="avatarUrl" render={({ field }) => (
            <FormItem className="md:col-span-1 lg:col-span-3">
              ...
              <FormDescription>
                {attendant ? "Faça upload de uma nova foto para alterar o avatar." : "Faça upload da foto do atendente."}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )} />
