...
import { Download, FileText, FileSpreadsheet, Database, Calendar, Users, BarChart3 } from "lucide-react";
                                ...
                                <div className="mt-4 pt-4 border-t">
                                    ...
                                    <div className="space-y-1 text-xs">
                                        ...
                                        {preview.hasAttendantFilter && (
                                            <div>• {reportData.filters.selectedAttendants.length} atendente(s) específico(s)</div>
                                        )}
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox 
                                    ...
                                    onCheckedChange={(checked) => setIncludeAttendantDetails(checked as boolean)}
                                />
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox 
                                    ...
                                    onCheckedChange={(checked) => setIncludeSentimentAnalysis(checked as boolean)}
                                />
                    ...
                    {exportFormat === 'csv' && (
                        <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <p className="text-sm text-yellow-800">
                                <strong>Nota:</strong> O formato CSV incluirá apenas dados tabulares. 
                                Gráficos e formatação visual não estarão disponíveis.
                            </p>
                        </div>
                    )}
                </div>
