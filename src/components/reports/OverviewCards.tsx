...
import { TrendingUp, Users, Star, MessageSquare, TrendingDown, Minus } from "lucide-react";
...
export function OverviewCards({
    ...
    const getTrendIcon = (value: number, threshold: number) => {
        ...
        if (value < threshold * 0.8) return <TrendingDown className="h-4 w-4 text-red-600" />;
