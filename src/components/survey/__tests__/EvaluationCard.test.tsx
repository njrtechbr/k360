...
import { EvaluationCard, EvaluationsList, CompactEvaluationCard, SimpleEvaluationCard } from '../EvaluationCard';
...
jest.mock('../RatingStars', () => ({
  RatingDisplay: ({ rating }: any) => <div data-testid="rating-display">Rating: {rating}</div>
}));
...
describe('EvaluationCard', () => {
  ...
  describe('Renderização básica', () => {
    ...
    it('deve renderizar comentário da avaliação', () => {
      ...
      expect(screen.getByText('Excelente atendimento, muito satisfeito!')).toBeInTheDocument();
    });
  ...
  describe('Avatar e iniciais', () => {
    ...
    it('deve gerar iniciais corretamente para nomes compostos', () => {
      const propsWithCompoundName = {
        ...defaultProps,
        attendant: { ...mockAttendant, nome: 'Maria da Silva Santos', avatar: undefined }
      };
  ...
  describe('Ações e interações', () => {
    ...
    it('deve chamar onView quando botão de visualizar é clicado', async () => {
      ...
      render(<EvaluationCard {...defaultProps} showActions onView={mockOnView} />);
    ...
    it('deve chamar onAttendantClick quando atendente é clicado', async () => {
      ...
      render(<EvaluationCard {...defaultProps} onAttendantClick={mockOnAttendantClick} />);
  ...
  describe('Estados especiais', () => {
    ...
    it('deve lidar com sentimento não definido', () => {
      const propsWithoutSentiment = {
        ...defaultProps,
        evaluation: { ...mockEvaluation, sentiment: undefined, confidence: undefined }
      };
      
      render(<EvaluationCard {...propsWithoutSentiment} />);
      
      expect(screen.queryByTestId('sentiment-analysis')).not.toBeInTheDocument();
    });
  });
});
...
describe('CompactEvaluationCard', () => {
  ...
  it('deve aceitar props adicionais', () => {
    const mockOnView = jest.fn();
    render(<CompactEvaluationCard {...mockProps} showActions onView={mockOnView} />);
...
describe('Acessibilidade', () => {
  ...
  it('deve ter textos alternativos para imagens', () => {
    const propsWithAvatar = {
      ...mockProps,
      attendant: { ...mockProps.attendant, avatar: 'https://example.com/avatar.jpg' }
    };
