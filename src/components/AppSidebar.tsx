          ...
          {canManageSystem && (
            <>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={pathname === "/dashboard/modulos"}
                  tooltip={{ children: "Gerenciar Módulos" }}
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={pathname === "/dashboard/backup"}
                  tooltip={{ children: "Sistema de Backup" }}
                >
