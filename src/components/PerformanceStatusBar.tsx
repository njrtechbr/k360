...
export default function PerformanceStatusBar() {
  ...
  const { dataLoadingTime, renderTime, itemCount, collectionName } =
    performanceData;
    ...
    <div className="fixed bottom-4 right-4 z-[9999] bg-background/80 backdrop-blur-sm border rounded-lg p-3 shadow-lg animate-in fade-in slide-in-from-bottom-5">
      <div className="flex items-center gap-6">
        ...
        <div
          ...
          title="Tempo de busca dos dados no Firestore"
        >
        ...
        <div
          className="flex items-center gap-2"
          title="Tempo de renderização do componente no navegador"
        >
        ...
        {itemCount !== null && (
          <div
            className="flex items-center gap-2"
            title={`Itens carregados da coleção "${collectionName}"`}
          >
