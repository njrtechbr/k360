...
describe("BackupList", () => {
  ...
  describe("Listagem de backups", () => {
    it("deve exibir todos os backups na tabela", () => {
      ...
      expect(
        screen.getByText("backup_2025-01-09_14-30-00.sql"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("backup_2025-01-09_15-45-30.sql"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("backup_2025-01-09_16-00-00.sql"),
      ).toBeInTheDocument();
    });
  ...
  describe("Funcionalidade de busca", () => {
    it("deve filtrar backups por nome do arquivo", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.queryByText("backup_2025-01-09_15-45-30.sql"),
  ...
  describe("Ações de backup", () => {
    it("deve chamar onDownload quando clicar no botão de download", () => {
      ...
      const enabledDownloadButton = downloadButtons.find(
