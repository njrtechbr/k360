      ...
      <Card>
        ...
        <CardContent>
          <div className="flex gap-4">
            ...
            >
              {monitoringActive ? <Square className="h-4 w-4" /> : <Play className="h-4 w-4" />}
              {monitoringActive ? 'Parar Monitoramento' : 'Iniciar Monitoramento'}
            </Button>
          ...
          {metrics && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{metrics.totalSizeGB} GB</div>
                  <p className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{metrics.averageDurationMinutes} min</div>
                  <p className="text-xs text-muted-foreground">
                    Por backup
                  </p>
                </CardContent>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {metrics.lastBackupDate 
                        ? new Date(metrics.lastBackupDate).toLocaleString('pt-BR')
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {metrics.oldestBackupDate 
                        ? new Date(metrics.oldestBackupDate).toLocaleString('pt-BR')
                        : 'Nenhum backup encontrado'
                      }
                    </p>
                  </div>
                ...
                <CardTitle className="flex items-center gap-2">
                  ...
                  <Badge variant={
                    ...
                    {healthCheck.status === 'healthy' ? 'Saudável' :
                     healthCheck.status === 'warning' ? 'Atenção' : 'Crítico'}
                  </Badge>
                </CardTitle>
                <CardDescription>
                  Última verificação: {new Date(healthCheck.lastCheck).toLocaleString('pt-BR')}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
