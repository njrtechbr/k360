...
describe("/api/gamification/xp-grants/statistics", () => {
  ...
  describe("GET - Obter estatísticas", () => {
    it("deve retornar estatísticas com sucesso", async () => {
      ...
      expect(mockXpAvulsoService.getGrantStatistics).toHaveBeenCalledWith(
        "30d",
      );
    });
    ...
    it("deve aceitar diferentes períodos válidos", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/gamification/xp-grants/statistics?period=7d",
      );
    ...
    it("deve retornar erro 400 para período inválido", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/gamification/xp-grants/statistics?period=invalid",
      );
      ...
      expect(data.error).toBe(
        "Período inválido. Períodos válidos: 7d, 30d, 90d",
      );
    ...
    it("deve lidar com dados vazios corretamente", async () => {
      ...
      const request = new NextRequest(
        "http://localhost/api/gamification/xp-grants/statistics?period=90d",
      );
