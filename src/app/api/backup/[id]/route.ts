...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.log(`[BACKUP_AUDIT] Exclusão iniciada por usuário ${session.user.id} (${userRole}): ${backupInfo.filename}`);
    ...
    console.log(`[BACKUP_AUDIT] Backup excluído com sucesso por usuário ${session.user.id} (${userRole}): ${backupInfo.filename}`);
