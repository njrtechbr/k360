...
export default function ConfigurarTrofeusPage() {
  ...
  const { achievements, updateAchievement, isAnyLoading } = useApi();
  ...
  const sortedAchievements = Array.isArray(achievements)
    ? [...achievements].sort((a, b) => a.xp - b.xp)
    : [];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Gerencie os troféus que os atendentes podem desbloquear para ganhar XP
          bônus.
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Ative, desative e edite o nome, descrição e XP de cada troféu.
              </CardDescription>
            </div>
            <Button
              variant="outline"
            ...
            <TableBody>
              {sortedAchievements.map((ach) => (
                <TableRow key={ach.id}>
                  <TableCell>
                    <div
                      className={`p-2 bg-muted rounded-full w-fit ${ach.color}`}
                    >
                  ...
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {field.value
                          ? "Este troféu está ativo e pode ser desbloqueado."
                          : "Este troféu está inativo."}
                      </p>
                    </div>
                    <FormControl>
                      <Switch
