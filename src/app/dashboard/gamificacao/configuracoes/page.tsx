...
export default function GamificacaoConfiguracoesPage() {
  ...
  const handleResetConfirm = async () => {
    try {
      ...
      if (response.ok) {
        alert("Dados de XP resetados com sucesso!");
      } else {
        alert("Erro ao resetar dados de XP");
      }
    } catch (error) {
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        <div>
          ...
          <p className="text-muted-foreground">
            Ajuste as regras, a pontuação, os troféus e as recompensas do
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Defina o XP base ganho ou perdido para cada nota de
                      avaliação.
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Configure tipos de XP que podem ser concedidos manualmente
                      aos atendentes.
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Configure limites diários, regras e controles para
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Ajuste o multiplicador global e os bônus por temporada.
                    </CardDescription>
                  </div>
                </div>
                <ChevronRight className="h-6 w-6 text-muted-foreground" />
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Edite o nome, a descrição, o XP e ative ou desative os
                      troféus.
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Verificar e desbloquear conquistas que deveriam ter sido
                      obtidas na temporada atual.
                    </CardDescription>
                  </div>
                </div>
                <ChevronRight className="h-6 w-6 text-muted-foreground" />
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Personalize as recompensas desbloqueadas a cada nível.
                    </CardDescription>
                  </div>
                </div>
                <ChevronRight className="h-6 w-6 text-muted-foreground" />
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Visualize a tabela completa de XP, estatísticas e
                      progresso da equipe.
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Crie e gerencie os períodos de validade dos passes de
                      batalha.
                    </CardDescription>
                  </div>
                </div>
        ...
        <Card className="border-destructive mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Ações nesta área são perigosas e irreversíveis. Tenha certeza
              absoluta antes de continuar.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex justify-between items-center p-4 border border-dashed border-destructive/50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Esta ação apagará TODOS os eventos de XP (pontos e troféus) de
                  TODOS os atendentes.
                </p>
              </div>
              <Button
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              todos os registros de XP (de avaliações e troféus) do sistema.
              Isso é útil para reiniciar a gamificação ou antes de uma
              reimportação total. Os dados de avaliações não serão afetados,
              apenas os pontos.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
