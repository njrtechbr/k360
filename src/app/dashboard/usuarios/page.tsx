...
export default function UsuariosPage() {
  ...
  const { allUsers, createUser, updateUser, deleteUser, isAnyLoading } =
    useApi();
  ...
  const activeModules = useMemo(
    () => modules?.data?.filter((m) => m.active) || [],
    [modules?.data],
  );
  ...
  async function onEditSubmit(values: z.infer<typeof editFormSchema>) {
    ...
    try {
      await updateUser.mutate({ userId: selectedUser.id, ...values });
  ...
  async function onDeleteConfirm() {
    if (!selectedUser) return;
    try {
      await deleteUser.mutate(selectedUser.id);
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Crie uma nova conta e defina suas permissões.
                </DialogDescription>
              </DialogHeader>
              <Form {...addForm}>
                <form
                    ...
                    render={() => (
                      <FormItem className="space-y-3 rounded-lg border p-4">
                        <div className="mb-4">
                          ...
                          <FormDescription>
                            Selecione os módulos que este usuário poderá
                            acessar.
                          </FormDescription>
                        </div>
              ...
              >
                ...
                <DialogFooter>
                  ...
                  <Button type="submit" disabled={updateUser.loading}>
                    {updateUser.loading ? "Salvando..." : "Salvar Alterações"}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                usuário "{selectedUser?.name}" e removerá seu acesso ao sistema.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
