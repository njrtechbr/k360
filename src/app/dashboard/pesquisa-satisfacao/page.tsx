    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          {analytics.totalEvaluations} avaliações •{" "}
          {analytics.evaluatedAttendants} atendentes
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Visualize gráficos e métricas sobre o desempenho dos atendentes.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Veja a lista completa com todas as avaliações recebidas.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Visualize relatórios completos com gráficos e métricas detalhadas.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use IA para analisar os comentários e extrair insights.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Importe avaliações de um arquivo CSV do WhatsApp.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Importe o histórico de avaliações do sistema legado.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Exclua avaliações específicas ou todas de uma vez.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
