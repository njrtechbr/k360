...
export default function NiveisPage() {
  ...
  const { attendants, seasonXpEvents, isAnyLoading } = useApi();
  ...
  const leaderboard = useMemo(() => {
    ...
    return (Array.isArray(attendants.data) ? attendants.data : [])
      .map((attendant) => {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Acompanhe a trilha de recompensas e o progresso de cada atendente.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Esta é a jornada de progressão completa. Desbloqueie recompensas ao
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Veja o nível e o progresso de cada atendente no sistema.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
