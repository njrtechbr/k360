...
import { ArrowLeft, History, Sparkles, Star, TrendingDown, TrendingUp, Trophy } from "lucide-react";
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2 text-muted-foreground">
                                    <Sparkles size={18}/>
                                    <span className="text-sm">Pontos de Experiência {activeSeason && `(${activeSeason.name})`}</span>
                                </div>
