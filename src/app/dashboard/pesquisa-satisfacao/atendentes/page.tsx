...
export default function AtendentesPage() {
  ...
  const sortedAttendants = Array.isArray(attendants)
    ? [...attendants].sort((a, b) => a.name.localeCompare(b.name))
    : [];
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleAddClick}>
          <PlusCircle className="mr-2 h-4 w-4" /> Adicionar Atendente
        </Button>
      </div>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Lista de todos os atendentes cadastrados no sistema.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            ...
            <TableBody>
              {sortedAttendants.map((att) => (
                <TableRow key={att.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={att.status === "Ativo" ? "secondary" : "outline"}
                    >
                      {att.status}
                    </Badge>
                  </TableCell>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link
                            href={`/dashboard/pesquisa-satisfacao/atendentes/${att.id}`}
                          >
                            <Eye className="mr-2 h-4 w-4" /> Ver Perfil
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onClick={() => handleQrCodeClick(att)}
                        >
      ...
      <Dialog open={isFormDialogOpen} onOpenChange={setIsFormDialogOpen}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedAttendant
                ? "Altere as informações do atendente."
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              atendente "{selectedAttendant?.name}".
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
