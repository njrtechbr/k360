...
export default function NovaAvaliacaoPage() {
  ...
  const { attendants, addEvaluation } = useApi();
  ...
  const handleSubmit = async (evaluationData: {
    ...
    try {
      ...
      toast({
        ...
        description:
          "A avaliação foi registrada e o XP foi atribuído ao atendente.",
      });
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Preencha os dados da avaliação. O XP será calculado automaticamente
            com base na nota.
          </CardDescription>
        </CardHeader>
        <CardContent>
