...
export class AchievementProcessor {
  /**
   * Processa conquistas automaticamente para um atendente na temporada atual
   */
  ...
  /**
   * Verifica se um atendente atende aos critérios de uma conquista na temporada atual
   */
  ...
  /**
   * Verifica sequência de avaliações 5 estrelas
   */
